...
- [x] Wire `buildAdapters`: chain registered as `nan-cloud` / "NaN Cloud (auto)" / provider `nan` — `0897c22`
...
- [x] Extension renders `nan-cloud` from `/api/models` (already dynamic) + `nan` provider label — `484572f`
